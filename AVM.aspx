<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AVM.aspx.cs" Inherits="test_1.AVM" %>
...
<body>
  ...
  <li class="auto-style16"><a href="AAgent.aspx" class="auto-style11"><strong>Add Agent</strong></a></li>
  <li class="auto-style16"><a href="VS.aspx" class="auto-style10"><strong> View Sales</strong></a></li>
  ...
  <div class="auto-style3">
      <strong>
      <asp:Label ID="lblVM" runat="server" Text="View Medicine" CssClass="auto-style5"></asp:Label>
      </strong>
    </div>
